...
// 2-pointer
// The idea is to maintain two pointers, one of which stores the list of nodes at
// odd positions and the other stores the list of nodes at an even position and then finally merge them.
